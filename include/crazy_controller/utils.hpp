...
// AUG Controller types and class
struct AUGResult {
    double speed;
    double acceleration;
    double jerk;
...
public:
    ...
    void set_diff_threshold(double v) { diff_threshold_ = v; }
    void set_deacc_gain(double v) { deacc_gain_ = v; }
    void set_kf(double v) { kf_ = v; }
    void set_kr(double v) { kr_ = v; }
    void set_Cf(double v) { Cf_ = v; }
    void set_Cr(double v) { Cr_ = v; }
...
private:
    ...
    Logger logger_warn_;
    double curr_steering_angle_;
    bool first_steering_calculation_;
